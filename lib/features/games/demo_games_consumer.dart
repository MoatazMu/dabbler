...
class DemoGamesConsumer extends ConsumerWidget {
  const DemoGamesConsumer({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final discoverAsync =
        ref.watch(gamesDiscoverProvider(const GamesDiscoverParams()));
