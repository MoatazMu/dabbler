...
class _CreateVenueSubmissionScreenState
  ...
  void initState() {
    ...
    _amenities = TextEditingController(text: (initial?.amenities ?? const []).join(', '));
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile.adaptive(
                      value: _isIndoor,
                      onChanged: isEditable ? (v) => setState(() => _isIndoor = v) : null,
                    ...
                    FilledButton.icon(
                      onPressed: (!isEditable || controller.isSaving)
                          ...
                          : () async {
                              ...
                              if (organiserId == null) {
                                final msg = organiserIdRes.requireError.message;
                      ...
                      onPressed: (!isEditable || controller.isSaving)
                          ...
                          : () async {
                              ...
                              if (id == null || id.isEmpty) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Save the draft first.')),
                                );
                                return;
                              }
                              ...
                              if (!(initial?.canSubmitForReview ?? true)) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('You can only submit drafts or returned submissions.')),
                                );
                                return;
                              }
