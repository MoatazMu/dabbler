...
final myOwnedSquadsProvider =
    FutureProvider.autoDispose<Result<List<Squad>>>((ref) {
...
final squadByIdProvider =
    FutureProvider.autoDispose.family<Result<Squad>, String>((ref, id) {
  final repo = ref.watch(squadsRepositoryProvider);
...
final squadCardsProvider = FutureProvider.autoDispose
    .family<Result<List<Map<String, dynamic>>>, ({String? squadId, int? limit, int? offset})>>(
        (ref, args) {
  final repo = ref.watch(squadsRepositoryProvider);
