...
class ManageSportsProfileUseCase {
  ...
  Future<Either<Failure, ManageSportsProfileResult>> _createSportProfile(
    ...
    final updatedProfile = UserProfile(
      id: currentProfile.id, userId: currentProfile.userId,
      ...
      city: currentProfile.city, country: currentProfile.country,
      phoneNumber: currentProfile.phoneNumber,
      username: currentProfile.username,
      gender: currentProfile.gender,
      profileType: currentProfile.profileType, intention: currentProfile.intention,
      verified: currentProfile.verified, isActive: currentProfile.isActive,
      geoLat: currentProfile.geoLat, geoLng: currentProfile.geoLng,
